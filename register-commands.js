...
const status = [{name:'Active',value:'Active'},{name:'Running',value:'Running'},{name:'BE (Break-even)',value:'BE'},{name:'Invalid',value:'Invalid'},{name:'Closed',value:'Closed'}];
const result = [{name:'Win',value:'Win'},{name:'Loss',value:'Loss'},{name:'Breakeven',value:'Breakeven'},{name:'Manual Close',value:'Manual Close'}];

const guildCommands = [
  new SlashCommandBuilder().setName('signal').setDescription('Post a trading signal (manual fill).')
  ...
  new SlashCommandBuilder().setName('signal-update').setDescription('Update an existing signal by ID or message link.')
